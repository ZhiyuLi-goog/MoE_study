# from https://github.com/eric-mitchell/direct-preference-optimization/blob/f8b8c0f49dc92a430bae41585f9d467d3618fe2f/preference_datasets.py
import datasets
import torch
        ...
        for k in batch[0].keys():
            if k.endswith('_input_ids') or k.endswith('_attention_mask') or k.endswith('_labels'):
                ...
                if k.endswith('_input_ids'):
                    padding_value = tokenizer.pad_token_id if tokenizer.pad_token_id else -100
