...
@hydra_runner(config_path="configs/hydra", config_name="megatron_mixtral_dpo_config")
def main(cfg) -> None:
    cfg.model = load_and_override_model_config(
        cfg.pretrained_checkpoint.restore_from_path, cfg.model
    )
